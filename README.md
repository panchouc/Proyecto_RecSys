...
- `modelo_lightgcn`: Contiene el modelo desarrollado a base de LightGCN. Los archivos principales son `LightGCN_V2.ipynb` (modelo base sin multimodalidad), `LightGCN_V2+Texto_AllMini.ipynb` (multimodalidad con texto usando modelo SBERT All-MiniLM-L6-v2), `LightGCN_V2+Texto_AllMpnet.ipynb` (multimodalidad con texto usando modelo SBERT All-Mpnet-Base-v2), `LightGCN_V2+Imagen.ipynb` (multimodalidad con imágenes), y `LightGCN_V2+Texto+Imagen.ipynb` (multimodalidad con texto e imágenes). Por otro lado, `LightGCN.ipynb` corresponde al código antiguo del hito 2.
