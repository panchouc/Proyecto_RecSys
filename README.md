...
El repositorio tiene 2 ramas principales:
...
- `modelos_ref`: Contiene los 4 modelos de referencia utilizados. El archivo principal es `modelos_referenciales.ipynb`.
